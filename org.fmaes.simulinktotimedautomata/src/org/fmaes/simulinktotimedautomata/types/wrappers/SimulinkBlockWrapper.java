...
public class SimulinkBlockWrapper {
  ...
  public Boolean isLibrary() {
    // make sure that you know the right parameter which determines if a referenced
    // subsystem is a library or not
  ...
  public String getLibraryAndSubsystem() {
    return String.format("%s/%s", getReferencedModelName(), getName());
  }
